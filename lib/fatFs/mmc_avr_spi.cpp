...
// #define printInfo(index, value, str)    do{printf("[ INFO ] (%d) SPCR=0x%02x @ %s.\r", index++, value, str);}while(0)
#define printInfo(index, value, str)    {}
